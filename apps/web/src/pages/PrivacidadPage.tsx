  ...
  return (
    <div className="min-h-screen bg-background px-6 py-10">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-2xl font-bold text-foreground mb-6">Política de privacidad</h1>
        <p className="text-sm text-foreground leading-6 whitespace-pre-line">{PRIVACIDAD_TEXT}</p>
      </div>
    </div>
  );
}
